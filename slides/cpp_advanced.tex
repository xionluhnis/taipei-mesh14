...
\end{lstlisting}
\misc{
	Definition of methods (including the constructor \ctext{vec} and/or its possible destructor \ctext{{\raise.17ex\hbox{$\scriptstyle\sim$}}vec} can be done separately.
}
\end{frame}
