...
\end{lstlisting}
\misc{
	\ctext{\&a} uses the \textbf{reference} operator to get the address of \ctext{a}.
	
	\ctext{*x} uses the \textbf{dereference} operator to get / set the value at the address given by \ctext{x}.
}
\end{frame}
