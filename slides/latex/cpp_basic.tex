...
% 3. Operators (unary, binary, arithmetic, comparator, bitwise)
...
\end{columns}
\misc{
	\textbf{Arrays} are continuous blocks of memory that store multiple elements of a same type. They use $0$-based indexing.
